  ...
  <div style="width: 1450px; margin: 0 auto">
    ...
    <div>
      <el-table :data="tableData" height="700px" border style="width: 100%">
        ...
        <el-table-column prop="data_time" label="Data_Time" :formatter="dateFormat" width="200px"></el-table-column>
        <el-table-column prop="wsf5" label="FastestWindSpeed-5s" width="180px"></el-table-column>
        <el-table-column prop="wsf2" label="FastestWindSpeed-2m" width="180px"></el-table-column>
        <el-table-column prop="wdf5" label="DirectionOfFastest5secWind" width="220px"></el-table-column>
        <el-table-column prop="wdf2" label="DirectionOfFastest2minWind" width="220px"></el-table-column>
        <el-table-column prop="awnd" label="AVGWindSpeed" width="160px"></el-table-column>
      </el-table>
      <el-pagination
  ...
  methods: {
    ...
    getTemperatureList () {
      ...
      if (this.dateValue === null) {
        ...
        this.$ajax.post('/api/basicData/wind/getListByDate/' + this.dateValue[0] + '/' + this.dateValue[1]).then(res => {
          if (res.status === 200) {
            this.currentPage = 1
        ...
        this.$ajax.post('/api/basicData/wind/getListByCityDate/' + this.city + '/' + this.dateValue[0] + '/' + this.dateValue[1]).then(res => {
          if (res.status === 200) {
            this.currentPage = 1
            this.totalData = res.data
            this.total = this.totalData.length
        ...
        this.$ajax.post('/api/basicData/wind/getListByStationDate/' + this.station + '/' + this.dateValue[0] + '/' + this.dateValue[1]).then(res => {
          if (res.status === 200) {
            this.currentPage = 1
            this.totalData = res.data
            this.total = this.totalData.length
