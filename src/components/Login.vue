<template>
  <el-container>
    <el-header style="display: flex; align-items: center; width: 100%; height: 150px">
      <span style="margin: 0 auto">Welcome to Weather Recording System</span>
    </el-header>
    <el-main style="margin-top: 120px; padding-top: 40px">
